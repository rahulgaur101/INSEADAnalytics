...
**Answers:<br>
1. I see high correlation responses which between the following<br> :

why would someone buy the boat? <br>
what kind of boat woudl they buy? <br>
what will they do with the boat ?<br>
...
**Answers
1.The plot and the dataimply that there are three characteristics of boat owners:<br>

component 1 type of customer that is adventure seeker<br>
Component 2 type of customer that is passionate about boating and boats<br>
Component 3 type of customer that views a boat as a status symbol<br> 
Component 4 type of customer that has a hgh willingness to pay for a qulaity boat(the premium customer)<br>
Component 5 type of customer that looks for most funcitonality at the least possible price <br>
Component 2 type of customer that does not buy maintenance services for basic issues <br>
...
**Answers
We now decided the questions that is most representative of each component in our analysis: <br>


component 1 type of customer that is adventure seeker is defined by Q21 (escapes from everyday life to relax on their boat)<br>
Component 2 type of customer that is passionate about boating and boats Q27 (boating is the number one thing to do when they have time to spare)<br>
Component 3 type of customer that views a boat as a status symbol Q9 (They want to buy the best boat with state of the art technology to use as a status symbol) <br> 
Component 4 type of customer that has a hgh willingness to pay for a qulaity boat Q4 (Very concious about the brand of boat they buy)(the premium customer)<br>
Component 5 type of customer that looks for most funcitonality at the least possible price Q2,12( buys the most basic boat with all bare essential functionality to satify need) <br>
Component 6 type of customer that does not buy maintenance services for basic issues Q11 (Fixes minor issues on the boat on their own) <br>
...
# Please use numbers, not column names, e.g. c(1:5, 7, 8) uses columns 1,2,3,4,5,7,8
segmentation_attributes_used = c(22,28,10,5,3,12) #c(10,19,5,12,3) 
