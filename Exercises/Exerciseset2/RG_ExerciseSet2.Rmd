...
**Answers<br>
1. 6 factors<br>
2. .96 for 5 yr T notes<br>
3.The ten components are: <br>
Government Bonds<br>
Foreign Currency<br>
European Stock market Index<br>
American Stock market Index<br>
European FX Futures<br> 
Oil & Gas<br>
Inudstrial metals <br>
Commodities<br>
Precious metals<br> 
Asian Stock market Index<br>

4.Before Crisis<br>

 precrisis_data = futures_data[as.Date(rownames(futures_data)) > "2002-11-01" & as.Date(rownames(futures_data)) < "2007-10-01", ]
 Variance_Explained_Table_results2<-PCA(precrisis_data, graph=FALSE)
 Variance_Explained_Table2<-cbind(paste("component",1:ncol(precrisis_data),sep=" "),Variance_Explained_Table_results2$eig)
...
duringcrisis_data = futures_data[as.Date(rownames(futures_data)) > "2007-10-01" & as.Date(rownames(futures_data)) < "2009-03-01", ]
 Variance_Explained_Table_results3<-PCA(duringcrisis_data, graph=FALSE)
 Variance_Explained_Table3<-cbind(paste("component",1:ncol(duringcrisis_data),sep=" "),Variance_Explained_Table_results3$eig)
...
**Answers<br>
1. The code creates intervals of 20 startong 10 through 250<br>
2.We would get returns over different intervals<br>
